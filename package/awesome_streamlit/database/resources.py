...
from awesome_streamlit.database.tags import (RISKS, ALTERNATIVE, APP, APP_IN_GALLERY,
...
RESOURCES_STREAMLIT_COMPONENT_APPS = [
    Resource(
        name="Common Project Risks",
        url="https://www.stakeholdermap.com/risk/register-common-project-risks.html",
        is_awesome=True,
        tags=[RISKS],
    ),
    Resource(
    ...
    Resource(
        name="Risk qualitative verses quantitative",
        url="https://backlog.com/blog/qualitative-risk-analysis-vs-quantitative-risk-analysis-whats-difference/",
        is_awesome=True,
        tags=[RISKS],
    ),
    Resource(
...
RESOURCES = (
    [
        ...
        Resource(name="Panel", url="http://panel.pyviz.org/", is_awesome=False, tags=[ALTERNATIVE]),
        Resource(
            name="Streamlit Demo",
        ...
        Resource(
            name="Plotly Dash", url="https://plot.ly/dash/", tags=[ALTERNATIVE], is_awesome=False
        ),
        Resource(
            name="Bokeh",
