...
my_grid = grid(4, [2, 2, 1], 2, 5, 1,  vertical_align="top")
...
successmsg = f'The PM Monitor project canvas project poster presented by {st.session_state.plpmname} on {st.session_state.pldcharterdate}.  Thank you for using The PM Monitor. thepmmonitor.streamlit.app.  Print and share this canvas with the team. '
